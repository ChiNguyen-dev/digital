...
@section('content')
    <div id="content" class="container-fluid pt-2">
        <div class="card">
            @include('partials.admin.title-form',['name'=>'Thêm vai trò'])
            <div class="card-body">
                <form method="POST" action="{{ route('roles.store') }}">
                    ...
                    <div class="form-input-group d-flex align-items-center">
                        ...
                        <textarea class="form-control" name="display_name" id="display_name" cols="30" rows="3"></textarea>
                    </div>
                    <div class="form-input-group d-flex align-items-center">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            @foreach($permissionParentItem->permissions as $permissionChildrentItem)
                                                <div class="col-md-3">
                                                    <div class="d-flex align-items-center">
                                                        <input type="checkbox" class="mr-2 action_role"
                                                               name="action_role[]"
