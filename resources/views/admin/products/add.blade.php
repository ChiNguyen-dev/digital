                    ...
                    <div class="content_box">
                        <div class="content active">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control tag-select2" multiple="multiple" name="tags[]"
                                        id="tags"></select>
                            </div>
                            <div class="form-group">
                                @error('tags')
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control color-select2" multiple="multiple" name="colors[]"
                                        id="colors">
                                    @if (!empty($colors))
                        ...
                        <div class="content">
                            <div class="form-group">
                                ...
                                <input class="form-control-file" type="file" name="feature_image_path"
                                       id="feature_image_path" multiple>
                            </div>
                            <div class="form-group">
