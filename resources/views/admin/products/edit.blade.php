...
@section('content')
    <div class="row container-fluid ml-0 pt-4">
        <div class="card w-100" id="add-product">
            @include('partials.admin.title-form',['name'=>'Chỉnh sửa sản phẩm'])
            <div class="card-body">
                <form method="post" action="{{ route('product.update',['id' => $product->id ]) }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="contents" class="form-control tinymce_editor_init" id="content" cols="30"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control tag-select2" multiple="multiple" name="colors[]" id="colors">
